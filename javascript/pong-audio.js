...
export var wallSound = new soundFile("khwall.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("khpaddle.mp3");
...
export var adventureMusic = new soundFile("destinyislands.mp3");
